dmit2015-winter2018-assignment01-starterproject: Assortment of technologies including Arquillian
========================
Author: Pete Muir
Level: Intermediate
...
There is a tutorial for this quickstart in the [Getting Started Developing Applications Guide](https://github.com/wildfly/quickstart/guide/dmit2015-winter2018-assignment01-starterproject/).
...
4. This will deploy `target/dmit2015-winter2018-assignment01-starterproject.war` to the running instance of the server.
 

Access the application 
---------------------

The application will be running at the following URL: <http://localhost:8080/dmit2015-winter2018-assignment01-starterproject/>.
